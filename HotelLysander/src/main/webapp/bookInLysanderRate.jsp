...
<%@page import="Model.bookInLysanderModel"%>

<%@ page import="Bill.BillCalc" %>
<%
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form" id="textbox">
                            ...
                            <p><%
                                bookInLysanderModel boolLysanderobj= new bookInLysanderModel();
                                int fee=boolLysanderobj.getHotelfee();
                            %>fee</p>
                        </div>
                    </div>
                </div>
